...
export class TablePaginationComponent<T extends Row = Row> {
  ...
  protected readonly isNextPageButtonDisabled = computed(() => this.paginationMetaConfig().page * this.paginationMetaConfig().pageSize >= this.paginationMetaConfig().total);
  ...
  protected readonly isLastPageButtonDisabled = computed(() => this.paginationMetaConfig().page * this.paginationMetaConfig().pageSize >= this.paginationMetaConfig().total);
