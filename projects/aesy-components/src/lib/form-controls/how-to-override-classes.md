...
En el caso de que queramos cambiar una variable host de un componente, como estos se copian en el overlay del componente (funcion copyCssVariablesToOverlay), lo que tendremos que hacer es especificar sobre el aesy-select o cualquiera y ya dentro lo podremos cambiar.
...
Si pusieramos --aesy-select-dropdown-option-height: 1rem; fuera del aesy-select, no surgiria efecto.
